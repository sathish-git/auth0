...
@Component(name = "My Custom Authentication Handler", immediate = true,
        property = {Constants.SERVICE_DESCRIPTION + "=Auth0 Authentication Handler",
                AuthenticationHandler.PATH_PROPERTY + "=/", Constants.SERVICE_RANKING + "=20"})
public class Auth0AuthenticationHandler extends DefaultAuthenticationFeedbackHandler implements AuthenticationHandler {

    private final Logger logger = LoggerFactory.getLogger(Auth0AuthenticationHandler.class);
